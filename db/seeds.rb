...
# Создание тестов
tests = Test.create!([
{ title: 'Test 1', level: 1, category_id: categories[0].id, user_id: users[0].id },
{ title: 'Test 2', level: 2, category_id: categories[1].id, user_id: users[1].id },
{ title: 'Test 3', level: 3, category_id: categories[2].id, user_id: users[2].id }
])
